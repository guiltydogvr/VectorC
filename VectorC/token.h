...
typedef enum {
	...
	TOKEN_BANG, TOKEN_BANG_EQUAL, TOKEN_EQUAL, TOKEN_EQUAL_EQUAL, TOKEN_GREATER, TOKEN_GREATER_EQUAL, TOKEN_LESS, TOKEN_LESS_EQUAL, TOKEN_SHIFT_LEFT, TOKEN_SHIFT_RIGHT, TOKEN_DEC, TOKEN_BITWISE_AND, TOKEN_LOGICAL_AND, TOKEN_AND_EQUAL, TOKEN_BITWISE_OR, TOKEN_LOGICAL_OR, TOKEN_OR_EQUAL, TOKEN_BITWISE_XOR,
